...
BEGIN_MESSAGE_MAP(CPracticeApp, CWinAppEx)
...
// CPracticeApp 사용자 지정 로드/저장 메서드

void CPracticeApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CPracticeApp::LoadCustomState()
{
}

void CPracticeApp::SaveCustomState()
{
}

...
public class MyActivity extends FragmentActivity implements OnMapClickListener {
    ...
    private void init() {
        ...
        GooglePlayServicesUtil.isGooglePlayServicesAvailable(MyActivity.this);
        mGoogleMap = ((SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.maps)).getMap();

        // 맵의 이동
        //mGoogleMap.moveCamera(CameraUpdateFactory.newLatLngZoom(position, 15));

        GPSInfo gps = new GPSInfo(MyActivity.this);
        // GPS 사용유무 가져오기
